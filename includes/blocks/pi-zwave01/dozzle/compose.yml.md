<!-- generated by stackdocs.py from pi-zwave01-dozzle.yml; edit the spec, not this file -->

//// details | compose.yml: the agent on pi-zwave01, 20 lines
    type: example
    open: true

[download compose.yml](../files/pi-zwave01/dozzle/compose.yml){ download="pi-zwave01-dozzle-compose.yml" }
{: .file-legend }
