<!-- generated by stackdocs.py from truenas1-dozzle.yml; edit the spec, not this file -->

//// details | compose.yml: the agent on truenas1, 19 lines
    type: example
    open: true

[download compose.yml](../files/truenas1/dozzle/compose.yml){ download="truenas1-dozzle-compose.yml" }
{: .file-legend }
